...
Finally, we’ll launch the CodeBuild job using the event details.
...
In this article, I explored a solution for running AWS infrastructure code changes automatically without trusting third party CI providers.
